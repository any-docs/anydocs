...
Named pages enable performing per-page layout and adding [page-breaks](/css/guides/Fragmentation) in a declarative manner when printing.
...
An example of this can be found on the [`page`](/css/reference/properties/page#examples) examples.
