...
> [!NOTE]
> The [CSS images](/css/guides/Images) module defines a `high-quality` value for the `image-rendering` property to provide a preference for higher-quality scaling, however, this is not supported in any browsers.
