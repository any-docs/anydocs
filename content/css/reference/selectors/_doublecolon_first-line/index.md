...
The **`::first-line`** [CSS](/en-US/docs/Web/CSS) [pseudo-element](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-elements) applies styles to the first line of a [block container](/css/guides/Display/Visual_formatting_model#block_containers).
