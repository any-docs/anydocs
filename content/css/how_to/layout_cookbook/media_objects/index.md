...
I have chosen to use [grid layout](/css/guides/Grid_layout) for the media object as it allows me to control the layout in two dimensions when I need to. This means that when we have a footer, with short content above, the footer can be pushed down to the bottom of the media object.
...
- [Using grid template areas](/css/guides/Grid_layout/Grid_template_areas)
