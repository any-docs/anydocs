...
The non-standard prefixed **`-webkit-mask-box-image`** [shorthand](/css/guides/Cascade/Shorthand_properties) property sets the mask image for an element's border box.
...
- [Initial value](/css/guides/Cascade/Property_value_processing#initial_value): `none`
- Applies to: all elements
- [Inherited](/css/guides/Cascade/Inheritance): no
- [Computed value](/css/guides/Cascade/Property_value_processing#computed_value): as specified
