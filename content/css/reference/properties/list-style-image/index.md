...
This example has a [CSS gradient](/css/guides/Images/Using_gradients) as a marker, which we create uses the {{cssxref("gradient/linear-gradient", "linear-gradient()")}} image function.
