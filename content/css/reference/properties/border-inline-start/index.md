...
The **`border-inline-start`** [CSS](/en-US/docs/Web/CSS) property is a [shorthand property](/css/guides/Cascade/Shorthand_properties) for setting the individual logical inline-start border property values in a single place in the style sheet.
