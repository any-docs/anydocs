...
The **`interpolate-size`** [CSS](/en-US/docs/Web/CSS) property allows you to enable [animations](/css/guides/Animations) and [transitions](/css/guides/Transitions) between a {{cssxref("&lt;length-percentage&gt;")}} value and an {{glossary("intrinsic size")}}, {{cssxref("fit-content")}}, or {{cssxref("max-content")}}.
