...
The **`-webkit-text-stroke`** [CSS](/en-US/docs/Web/CSS) property specifies the [width](/css/reference/values/length) and [color](/css/reference/values/color_value) of strokes for text characters. This is a shorthand property for the longhand properties {{cssxref("-webkit-text-stroke-width")}} and {{cssxref("-webkit-text-stroke-color")}}.
