...
The **`height`** [CSS](/en-US/docs/Web/CSS) property specifies the height of an element. By default, the property defines the height of the [content area](/css/guides/Box_model/Introduction#content_area). If {{cssxref("box-sizing")}} is set to `border-box`, however, it instead determines the height of the [border area](/css/guides/Box_model/Introduction#border_area).
...
- {{cssxref("&lt;percentage&gt;")}}
  - : Defines the height as a percentage of the [containing block](/css/guides/Display/Containing_block)'s height.
- `auto`
