...
The **`initial-value`** descriptor of the {{cssxref("@property")}} [at-rule](/css/guides/Syntax/At-rules) specifies the initial value for the registered [CSS custom property](/css/reference/properties/--*).
