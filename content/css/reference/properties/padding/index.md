...
The **`padding`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/css/guides/Cascade/Shorthand_properties) sets the [padding area](/css/guides/Box_model/Introduction#padding_area) on all four sides of an element at once.
...
- {{cssxref("&lt;percentage&gt;")}}
  - : The size of the padding as a percentage, relative to the inline size (_width_ in a horizontal language, defined by {{cssxref("writing-mode")}}) of the [containing block](/css/guides/Display/Containing_block).
