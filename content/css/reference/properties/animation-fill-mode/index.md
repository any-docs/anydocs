...
> [!NOTE]
> `animation-fill-mode` has the same effect when creating [CSS scroll-driven animations](/css/guides/Scroll-driven_animations) as it does for regular time-based animations.
