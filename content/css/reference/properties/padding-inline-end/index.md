...
- {{cssxref("&lt;percentage&gt;")}}
  - : The size of the padding as a percentage, relative to the [inline-size](/css/guides/Display/Block_and_inline_layout) (_width_ in a horizontal language) of the [containing block](/css/guides/Display/Containing_block). Must be nonnegative.
