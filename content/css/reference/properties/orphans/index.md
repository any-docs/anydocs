...
The **`orphans`** [CSS](/en-US/docs/Web/CSS) property sets the minimum number of lines in a block container that must be shown at the _bottom_ of a [page](/css/guides/Paged_media), region, or [column](/css/guides/Multicol_layout).
...
- {{cssxref("widows")}}
- [Paged media](/css/guides/Paged_media)
