...
The **`@color-profile`** [CSS](/en-US/docs/Web/CSS) [at-rule](/css/guides/Syntax/At-rules) defines and names a color profile which can later be used in the {{cssxref("color_value/color", "color()")}} function to specify a color.
