...
The **`inherit`** [CSS](/en-US/docs/Web/CSS) keyword causes the element to take the [computed value](/css/guides/Cascade/Property_value_processing#computed_value) of the property from its parent element. It can be applied to any CSS property, including the CSS shorthand property {{cssxref("all")}}.

For [inherited properties](/css/guides/Cascade/Inheritance#inherited_properties), this reinforces the default behavior, and is only needed to override another rule.
