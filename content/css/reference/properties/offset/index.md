...
The **`offset`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/css/guides/Cascade/Shorthand_properties) sets all the properties required for animating an element along a defined path. The offset properties together help to define an _offset transform_, a [transform](/css/guides/Transforms/Using) that aligns a point in an element ([offset-anchor](/css/reference/properties/offset-anchor)) to an _offset position_ ([offset-position](/css/reference/properties/offset-position)) on a path ([offset-path](/css/reference/properties/offset-path)) at various points along the path ([offset-distance](/css/reference/properties/offset-distance)) and optionally rotates the element ([offset-rotate](/css/reference/properties/offset-rotate)) to follow the direction of the path.
