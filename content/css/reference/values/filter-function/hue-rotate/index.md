...
The **`hue-rotate()`** [CSS](/en-US/docs/Web/CSS) [function](/css/reference/values/Functions) rotates the [hue](https://en.wikipedia.org/wiki/Hue) of an element and its contents. Its result is a {{cssxref("filter-function")}}.
