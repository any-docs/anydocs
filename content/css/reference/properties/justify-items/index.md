...
- In table cell layouts, this property is _ignored_ (see [Box alignment for block, absolutely positioned, and table layouts](/css/guides/Box_alignment/In_block_abspos_tables))
- In flexbox layouts, this property is _ignored_ (see [Box alignment in flexbox](/css/guides/Box_alignment/In_flexbox))
- In grid layouts, it aligns the items inside their grid areas on the inline axis (see [Box alignment in grid layout](/css/guides/Box_alignment/In_grid_layout))
...
- `anchor-center`
  - : In the case of [anchor-positioned](/css/guides/Anchor_positioning) elements, aligns the items to the center of the associated anchor element in the inline direction. See [Centering on the anchor using `anchor-center`](/css/guides/Anchor_positioning/Using#centering_on_the_anchor_using_anchor-center).
- `safe`
