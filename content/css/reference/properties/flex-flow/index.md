...
The **`flex-flow`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/css/guides/Cascade/Shorthand_properties) specifies the direction of a flex container, as well as its wrapping behavior.
