...
> [!NOTE]
> In Gecko, background images created using the [`element()`](/css/reference/values/element) function are currently treated as images with the dimensions of the element, or of the background positioning area if the element is SVG, with the corresponding intrinsic proportion. This is non-standard behavior.
...
See [Resizing background images](/css/guides/Backgrounds_and_borders/Resizing_background_images) for more examples.
