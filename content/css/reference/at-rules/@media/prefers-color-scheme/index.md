...
The **`prefers-color-scheme`** [CSS](/en-US/docs/Web/CSS) [media feature](/css/guides/Media_queries/Using#targeting_media_features) is used to detect if a user has requested light or dark color themes.
