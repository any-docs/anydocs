...
- `-moz-box-align` {{deprecated_inline}}: Use [CSS flexbox](/css/guides/Flexible_box_layout) with {{CSSxRef("align-items")}}.
- `-moz-background-inline-policy` {{deprecated_inline}}: Not supported; use {{CSSxRef("box-decoration-break")}}.
- `-moz-box-direction` {{deprecated_inline}}: Use [CSS flexbox](/css/guides/Flexible_box_layout) with {{CSSxRef("flex-direction")}}.
- `-moz-box-flex` {{deprecated_inline}}: Use [CSS flexbox](/css/guides/Flexible_box_layout) with {{CSSxRef("flex-grow")}}.
- `-moz-box-ordinal-group` {{deprecated_inline}}: Use [CSS flexbox](/css/guides/Flexible_box_layout) with {{CSSxRef("order")}}.
- `-moz-box-orient` {{deprecated_inline}}: Use [CSS flexbox](/css/guides/Flexible_box_layout) with {{CSSxRef("flex-direction")}}.
- `-moz-box-pack` {{deprecated_inline}}: Use [CSS flexbox](/css/guides/Flexible_box_layout) with {{CSSxRef("justify-content")}}.
...
- `-moz-crisp-edges` {{deprecated_inline}}: Use [`crisp-edges`](/css/reference/properties/image-rendering#crisp-edges).
...
See [Browser Compatibility](/css/reference/properties/list-style-type#browser_compatibility) for details.
...
- `-moz-available`: See [`stretch`](/css/reference/properties/width#stretch).
