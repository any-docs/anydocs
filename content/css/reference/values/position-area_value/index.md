...
The **`<position-area>`** [CSS](/en-US/docs/Web/CSS) [data type](/css/reference/values/Data_types) defines the cell or spanned cells of a **position-area grid**, a 3x3 grid whose center cell is an anchor element.
...
- [`anchor()`](/css/reference/values/anchor) function
