...
The **`padding-left`** [CSS](/en-US/docs/Web/CSS) property sets the width of the [padding area](/css/guides/Box_model/Introduction#padding_area) to the left of an element.
...
- [Introduction to the CSS basic box model](/css/guides/Box_model/Introduction)
