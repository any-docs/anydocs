...
The **`mask-border`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/css/guides/Cascade/Shorthand_properties) lets you create a mask along the edge of an element's border.
