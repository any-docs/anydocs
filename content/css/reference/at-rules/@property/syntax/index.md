...
The **`syntax`** descriptor of the {{cssxref("@property")}} [at-rule](/css/guides/Syntax/At-rules) defines the allowed value types for the registered [CSS custom property](/css/reference/properties/--*).
It controls how the property's specified value is processed to derive the [computed value](/css/guides/Cascade/Property_value_processing#computed_value).
