...
The **`pow()`** [CSS](/en-US/docs/Web/CSS) [function](/css/reference/values/Functions) is an exponential function that returns the value of a base raised to the power of a number.
