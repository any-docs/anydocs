...
A relative selector list is a comma-separated selector list parsed as [relative selectors](/css/guides/Selectors/Selector_structure#relative_selector), which begin with an explicit or implied combinator.
