...
The **`padding-right`** [CSS](/en-US/docs/Web/CSS) property sets the width of the [padding area](/css/guides/Box_model/Introduction#padding_area) on the right of an element.
