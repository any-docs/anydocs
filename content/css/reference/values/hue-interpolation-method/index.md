...
The **`<hue-interpolation-method>`** [CSS](/en-US/docs/Web/CSS) [data type](/css/reference/values/Data_types) represents the algorithm used for interpolation between {{cssxref("hue")}} values.
