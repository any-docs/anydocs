...
2. A script subtag with 4 letters <Badge type="info" text="Optional" />
3. A region subtag with either 2 letters or 3 digits <Badge type="info" text="Optional" />
4. One or more variant subtags (all of which must be unique), each with either 5–8 alphanumerals or a digit followed by 3 alphanumerals <Badge type="info" text="Optional" />
5. One or more {{glossary("BCP 47 language tag", "BCP 47")}} extension sequences <Badge type="info" text="Optional" />
6. A private-use extension sequence <Badge type="info" text="Optional" />
