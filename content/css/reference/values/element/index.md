...
The **`element()`** [CSS](/en-US/docs/Web/CSS) [function](/css/reference/values/Functions) defines an {{cssxref("image")}} value generated from an arbitrary HTML element. This image is live, meaning that if the HTML element is changed, the CSS properties using the resulting value are automatically updated.
