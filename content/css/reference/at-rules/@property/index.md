...
The **`@property`** [CSS](/en-US/docs/Web/CSS) [at-rule](/css/guides/Syntax/At-rules) is part of the [CSS Houdini](/en-US/docs/Web/API/Houdini_APIs) set of APIs. It allows developers to explicitly define [CSS custom properties](/css/reference/properties/--*), allowing for property type checking and constraining, setting default values, and defining whether a custom property can inherit values or not.
...
- [Using CSS custom properties (variables)](/css/guides/Cascading_variables/Using_custom_properties) guide
