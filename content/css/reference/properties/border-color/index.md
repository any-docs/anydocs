...
The **`border-color`** [shorthand](/css/guides/Cascade/Shorthand_properties) [CSS](/en-US/docs/Web/CSS) property sets the color of an element's border.
...
You can find out more information about border colors in [Applying colors to HTML elements](/css/guides/Colors/Applying_color#borders).
