...
The **`inherits`** [CSS](/en-US/docs/Web/CSS) descriptor of the {{cssxref("@property")}} [at-rule](/css/guides/Syntax/At-rules) controls whether or not the registered [CSS custom property](/css/reference/properties/--*) inherits by default.
