...
The **`margin-left`** [CSS](/en-US/docs/Web/CSS) property sets the [margin area](/css/guides/Box_model/Introduction#margin_area) on the left side of an element. A positive value places it farther from its neighbors, while a negative value places it closer.
