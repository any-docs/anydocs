...
Do not use the `-webkit-transition` media feature. Instead, test for transition support using the CSS {{cssxref("@supports")}} [at-rule](/css/guides/Syntax/At-rules), like this:
...
- {{cssxref("transition")}} and [using CSS transitions](/css/guides/Transitions/Using)
- {{cssxref("@media")}} and [Using media queries](/css/guides/Media_queries/Using)
- {{cssxref("@supports")}} and [using feature queries](/css/guides/Conditional_rules/Using_feature_queries)
