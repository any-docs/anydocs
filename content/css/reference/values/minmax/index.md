...
The **`minmax()`** [CSS function](/css/reference/values/Functions) defines a size range greater than or equal to _min_ and less than or equal to _max_. It is used with [CSS grids](/css/guides/Grid_layout).
...
- [Basic concepts of grid layout: track sizing with minmax()](/css/guides/Grid_layout/Basic_concepts#track_sizing_and_minmax)
- [CSS grids, logical values and writing modes](/css/guides/Grid_layout/Logical_values_and_writing_modes)
