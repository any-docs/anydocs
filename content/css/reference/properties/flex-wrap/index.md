...
- `wrap`
  - : The flex items break into multiple lines. The cross-start is the equivalent of [inline-start or block-start](/en-US/docs/Glossary/Flow_relative_values), depending on the current [writing mode](/css/guides/Writing_modes), and the {{cssxref("flex-direction")}} value.
- `wrap-reverse`
